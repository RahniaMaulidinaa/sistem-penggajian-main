...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <!-- Produksi Harian Card Example -->
    <div class="col-xl-3 col-md-6 mb-4">
      <a href="<?php echo base_url('produksi_harian'); ?>" class="text-decoration-none">
        <div class="card border-left-warning shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo ($total_produksi_harian > 0) ? $total_produksi_harian : 'Belum ada data'; ?></div>
              </div>
              <div class="col-auto">
