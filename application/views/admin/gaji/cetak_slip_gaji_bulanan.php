...
<body>
    <div class="container">
        ...
        <table class="main-table">
            ...
            <tr>
                <td>Gaji Pokok</td>
                <td>Rp. <?php echo number_format($slip_gaji->gaji_pokok, 0, ',', '.') ?></td>
                <td rowspan="3">
            ...
            <tr>
                ...
                <td>Rp. <?php echo number_format($slip_gaji->tj_transport, 0, ',', '.') ?></td>
            </tr>
            <tr>
                <td>Uang Makan</td>
                <td>Rp. <?php echo number_format($slip_gaji->uang_makan, 0, ',', '.') ?></td>
            </tr>
            <tr class="total">
                <td>Total Pendapatan</td>
                <td colspan="2">
                    <?php $total_gaji = ($slip_gaji->gaji_pokok + $slip_gaji->tj_transport + $slip_gaji->uang_makan) - $potongan_gaji; ?>
